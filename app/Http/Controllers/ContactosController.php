...
class ContactosController extends Controller
{
   ...
   //ELIMINAR CLIENTES Y PROVEEDORES
    ...
    public function ListaContactosProveedores($id)
    {
        ...
        $query = Contactos::select('contactos.*','gerentes.id','gerentes.nombre','gerentes.apellido_paterno','gerentes.apellido_materno','negocios.nombre as negocio','negocios.telefono','gerentes.user_id','users.status')
