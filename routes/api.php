...
Route::middleware('jwt.auth:api')->post('/buscar-productos/{id}', 'ProductoController@buscarProductos', function (Request $request) {
    return $request->producto();
});
...
Route::middleware('jwt.auth:api')->post('/obtener-productos-proveedor/{id}', 'ProductoController@listaProductosProveedor');
Route::middleware('jwt.auth:api')->post('/buscar-proveedor-producto', 'ProductoController@BuscarProveedorProducto');
    ...
    Route::middleware('jwt.auth:api')->post('/buscar-producto-marca', 'ProductoController@listaProductosMarcaProveedor');
...
Route::middleware('jwt.auth:api')->post('/borrar-contacto', 'ContactosController@destroy');
...
Route::middleware('jwt.auth:api')->get('/pedidos-finalizados-proveedor/{id}', 'PedidosController@pedidosFinalizadosDelProveedor');
...
Route::middleware('jwt.auth:api')->put('/actualizar-status-pago/{id}', 'PedidosController@actualizarPagoACompletado');
